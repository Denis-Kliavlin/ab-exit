...
if (currentIndex >= 0) {
  const visitedKey = "ab-exit.simulation.visited.v1";
  let visited = [];
  try {
  ...
  nav.setAttribute("aria-label", "AB-EXIT simulation system");
  const next = steps[currentIndex + 1];
  nav.innerHTML = `
    <div class="abj-inner">
      <a class="abj-home" href="../index.html">AB-EXIT · Simulation System</a>
      <ol class="abj-steps">
