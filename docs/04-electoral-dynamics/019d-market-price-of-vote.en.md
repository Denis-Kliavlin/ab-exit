...
**Chapter:** 04 — Electoral Dynamics (paired with §19b)
**File:** 04_019d · v1 · 19 September 2026
**Source:** the architect's and the assistant's analysis of the question "will the elderly take money instead of a vote, and are polls needed for that" (048g.3c); Moldovan police data on the vote-buying scheme of autumn 2024; data on the price of a vote in Bulgaria and the Philippines.
